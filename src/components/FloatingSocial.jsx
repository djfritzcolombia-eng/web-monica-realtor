...
export default function FloatingSocial({
    ...
    const wrapStyle = placement === "side" && !isMobile
        ? sx.wrapSide
        : {
            ...sx.wrapBottom,
            gap: isMobile ? 10 : 20,
                    ...
                    >
                        <span
                            ...
                            onMouseEnter={e => {
                                ...
                                e.currentTarget.style.background = "var(--fill-nude, #f3ede6)";
                                e.currentTarget.style.borderColor = "var(--border-nude, #e6dace)";
                            }}
                            onMouseLeave={e => {
                                e.currentTarget.style.transform = "translateY(0)";
                                e.currentTarget.style.background = "var(--surface-bg, #ffffff)";
                                e.currentTarget.style.borderColor = "var(--border-subtle, #e8e4df)";
                            }}
                        >
                            <span style={{
                                ...sx.icon,
